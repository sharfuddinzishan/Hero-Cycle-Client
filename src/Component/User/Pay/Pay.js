...
const Pay = () => {
    ...
    useEffect(() => {
        orderID && axios.get(`https://hero-cycle-server-side-production.up.railway.app/orders/${orderID}`)
            .then(result => {
                // console.log(result)
...
{
        load && getSingleOrderDetails?.orderStatus!=="confirm" && <div className="card-body">
